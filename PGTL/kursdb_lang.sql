...
CREATE TABLE IF NOT EXISTS `kurse`.`personen` (
  ...
  `per_vorname` VARCHAR(45) NOT NULL UNIQUE,
  `per_nachname` VARCHAR(45) NOT NULL UNIQUE,
  `pea_id` INT NOT NULL,
...
START TRANSACTION;
USE `kurse`;
INSERT INTO `kurse`.`bezeichnung` (`bez_id`, `bez_bezeichnung`) VALUES (DEFAULT, 'SQL Kurs');
INSERT INTO `kurse`.`bezeichnung` (`bez_id`, `bez_bezeichnung`) VALUES (DEFAULT, 'PHP Kurs');
...
INSERT INTO `kurse`.`kurse` (`kur_id`, `kur_preis`, `kur_start`, `kur_ende`, `kur_set`, `bez_id`) VALUES (DEFAULT, 112, '2018-11-11', '2018-11-04', NULL, 3);
...
INSERT INTO `kurse`.`kurse` (`kur_id`, `kur_preis`, `kur_start`, `kur_ende`, `kur_set`, `bez_id`) VALUES (DEFAULT, 12, '2018-07-29', '2018-09-29', NULL, 2);
